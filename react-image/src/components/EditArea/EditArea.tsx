  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium">
            Saturation: {state.filterSettings.saturation}
          </label>
          <Slider
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium">
            Highlights: {state.filterSettings.highlights}
          </label>
          <Slider
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium">
            Shadows: {state.filterSettings.shadows}
          </label>
          <Slider
        ...
        <div className="space-y-2">
          ...
          <Select
            value={state.filterSettings.artStyle}
            onValueChange={(value) => 
              dispatch({
                type: 'UPDATE_FILTER',
                payload: { artStyle: value as FilterSettings['artStyle'] }
              })
            }
          >
            {artStyles.map(style => (
